...
\author{Karthik Nambiar \and Sumedh Nitin Jamsandekar \and Paul Ti\kern0pt ju Thomas\\[4pt]
...
\begin{figure}[t]\centering\includegraphics[width=0.62\textwidth]{fig4-coverage}
...
\begin{figure}[p]\centering\includegraphics[width=\textwidth]{fig1-graph}
...
\begin{figure}[t]\centering\includegraphics[width=0.62\textwidth]{fig2-leakage}
...
\begin{figure}[t]\centering\includegraphics[width=0.92\textwidth]{fig3-perturbation}
...
\begin{figure}[t]\centering\includegraphics[width=0.92\textwidth]{fig5-loads}
...
\begin{figure}[t]\centering\includegraphics[width=0.92\textwidth]{fig6-funnel}
...
\begin{figure}[t]\centering\includegraphics[width=\textwidth]{fig7-scores}
...
\begin{figure}[t]\centering\includegraphics[width=\textwidth]{fig8-smaa}
...
\begin{figure}[t]\centering\includegraphics[width=0.95\textwidth]{fig9-premortem}
...
\begin{figure}[t]\centering\includegraphics[width=0.6\textwidth]{fig11-pickscores}
...
\begin{figure}[t]\centering\includegraphics[width=0.95\textwidth]{fig10-priorart}
